...
set -g status-bg '#f3efdf' 
set -g status-fg '#5c6a72'
set -g status-right '#[fg=#35a77c]#[bg=#f3efdf] %H:%M '
set -g window-status-format "#[fg=#708089, bg=#f3efdf] #I #[fg=#5c6a72, bg=#f3efdf] #W "
...
local function apply_theme(config)
	config.colors = {
		...
		selection_fg = "#d3c6aa",
		selection_bg = "#3d484d",
		ansi = { "#2d353b", "#e67e80", "#a7c080", "#dbbc7f", "#7fbbb3", "#d699b6", "#83c092", "#d3c6aa" },
...
local function apply_theme(config)
	config.colors = {
		...
		selection_bg = "#edeada",
		selection_fg = "#5c6a72",
		ansi = { "#f3efdf", "#f85552", "#8da101", "#dfa000", "#3a94c5", "#df69ba", "#35a77c", "#5c6a72" },
		brights = { "#a6b0a0", "#f85552", "#8da101", "#dfa000", "#3a94c5", "#df69ba", "#35a77c", "#5c6a72" },
	}
	return config
end
